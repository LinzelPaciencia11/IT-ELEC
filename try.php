...
<body>
    ...
    foreach ($books as $book) {
        ...
        echo "{$book['title']} - Price: $".number_format($book['price'], 2).", Quantity: {$book['quantity']}, Total: $".number_format($totalValue, 2)."<br>";
        $total += $totalValue;
    }
    ...
    foreach ($group1 as $book) {
        echo "{$book['title']} - Price: $".number_format($book['price'], 2)."<br>";
    }
    echo "<br>";
    echo "Group 2:<br>";
